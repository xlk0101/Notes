...
public class NotesListActivity extends Activity implements OnClickListener, OnItemLongClickListener
{
    ...
    private static final String ROOT_FOLDER_SELECTION =
            "(" + NoteColumns.TYPE + "<>" + Notes.TYPE_SYSTEM + " AND " + NoteColumns.PARENT_ID + "=?)" + " OR (" +
        ...
        public boolean onMenuItemClick(MenuItem item)
        {
            ...
            switch (item.getItemId())
            {
                case R.id.delete:
                    ...
                    builder.setMessage(
                            getString(R.string.alert_message_delete_notes, mNotesListAdapter.getSelectedCount()));
    ...
    private void startAsyncNotesListQuery()
    {
        ...
        mBackgroundQueryHandler.startQuery(FOLDER_NOTE_LIST_QUERY_TOKEN, null, Notes.CONTENT_NOTE_URI,
                                           NoteItemData.PROJECTION, selection, new String[] {
    ...
    private void showFolderListMenu(Cursor cursor)
    {
        ...
        builder.setAdapter(adapter, new DialogInterface.OnClickListener()
        {
            public void onClick(DialogInterface dialog, int which)
            {
                DataUtils.batchMoveToFolder(mContentResolver, mNotesListAdapter.getSelectedItemIds(),
                                            adapter.getItemId(which));
                Toast.makeText(NotesListActivity.this,
                               getString(R.string.format_move_notes_to_folder, mNotesListAdapter.getSelectedCount(),
                                         adapter.getFolderName(NotesListActivity.this, which)), Toast.LENGTH_SHORT)
                     .show();
    ...
    private void showCreateOrModifyFolderDialog(final boolean create)
    {
        ...
        positive.setOnClickListener(new OnClickListener()
        {
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(NotesListActivity.this, getString(R.string.folder_exist, name), Toast.LENGTH_LONG)
                         .show();
    ...
    public boolean onPrepareOptionsMenu(Menu menu)
    {
        ...
        if (mState == ListEditState.NOTE_LIST)
        {
            ...
            menu.findItem(R.id.menu_sync)
                .setTitle(GTaskSyncService.isSyncing() ? R.string.menu_sync_cancel : R.string.menu_sync);
        }
        ...
        new AsyncTask<Void, Void, Integer>()
        {
            ...
            protected void onPostExecute(Integer result)
            {
                ...
                else if (result == BackupUtils.STATE_SUCCESS)
                {
                    ...
                    builder.setMessage(NotesListActivity.this.getString(R.string.format_exported_file_location,
    ...
    private void startQueryDestinationFolders()
    {
        ...
        mBackgroundQueryHandler.startQuery(FOLDER_LIST_QUERY_TOKEN, null, Notes.CONTENT_NOTE_URI,
                                           FoldersListAdapter.PROJECTION, selection, new String[] {
                        String.valueOf(Notes.TYPE_FOLDER), String.valueOf(Notes.ID_TRASH_FOLER),
                        String.valueOf(mCurrentFolderId) }, NoteColumns.MODIFIED_DATE + " DESC");
    }
